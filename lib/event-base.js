...
var Utils = require('./event-base/utils');
var Observer = require('./event-base/observer');
var Observable = require('./event-base/observable');
...
module.exports = {
    version: '@VERSION@',
    Utils: Utils,
    Object: require('./event-base/object'),
    Observer: Observer,
